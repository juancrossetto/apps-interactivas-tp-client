        ...
        <div className="container w-75 p-3">
          ...
          <TableHead>
            <TableRow>
              ...
              <StyledTableCell align="center">Fecha&nbsp;de&nbsp;Juego</StyledTableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {(rowsPerPage > 0
              ...
              <TableRow key={row.position}>
                <StyledTableCell  align="right" component="th" scope="row">{row.position}</StyledTableCell>
                <StyledTableCell align="right">
                  <Avatar alt="No Data" src={row.avatar}>{row.name.charAt(0).toUpperCase()}</Avatar>  
                </StyledTableCell>
                <StyledTableCell align="left">
                  {row.name}
                </StyledTableCell>
                <StyledTableCell>
                  <Rating align="left" name="half-rating-read size-large" defaultValue={row.score / 100} precision={0.01} readOnly />
                  ({row.score})
                </StyledTableCell>
