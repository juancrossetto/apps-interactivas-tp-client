    ...
    <Layout isAuth={true}>
      ...
      <style jsx>{`
        ...
        *:after {
        ...
        .formulario-nuevo-ejercicio .input-text {
          border-bottom: 1px solid var(--gris2);
          border-radius: 0;
          background-color: var(--gris1);
        }
        .formulario-nuevo-ejercicio .input-text::placeholder {
          color: var(--gris2);
        }
        .ejercicios {
          margin-top: 10rem;
